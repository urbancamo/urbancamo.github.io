...
and 64MB of RAM, with a 1024x768 display, build in CD-ROM and floppy disk drive. I'm using a 
Cisco Systems network card to access the internet via an unencrypted Wi-Fi access point with
...
![screenshot](./rc2025_10/images/hellopas.png)
...
![Thinkpad Desktop Screenshot](./rc2025_10/images/thinkpad.png)
...
Having consulted with ChatGPT I rediscovered the [Rosetta Code](https://rosettacode.org/)
website, which has implementations of many algorithms in many
languages. I picked the [N-Queens problem](https://rosettacode.org/wiki/N-queens_problem),
which is a classic computer science problem.
...
I watched a [youtube video](https://www.youtube.com/watch?v=fD4ktSkNCw4&t=1723s) a while back by Ryan Carson
about creating structure for an LLM to have the best opportunity to succeed. The basic premise is to provide
the LLM with context and structure to work within, rather than just a free-form prompt. You also create
checklists of steps to follow, and provide examples of the desired output.

As I am using CLAUDE I'm going to try and recreate the same structure, but target it to the CLAUDE environment.
I'll use CLAUDE to help with this.

I'm going attempt the nqueens problem using VAX Pascal, as I think this will be a good test of CLAUDE's

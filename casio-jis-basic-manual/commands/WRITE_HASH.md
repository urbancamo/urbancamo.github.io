...
4. Multiple data items can be delimited using commas.
...
6. 255 characters per line can be written using this command, and an error is generated when this limit is exceeded.

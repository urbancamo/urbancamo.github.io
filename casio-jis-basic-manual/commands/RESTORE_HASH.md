...
### Format
```basic
RESTORE# [ "object string" [ , { 0 | 1 } ] [ , { line number | #program area number } ] ]
```
...
2. The relationship between the parameters and the object string are as follows:
   ...
   2. `RESTORE# "object string"`
      ...
      Strings are delimited by commas, and not by spaces. A DA error is generated when the object string cannot be found.
   3. `RESTORE# "object string" [, { 0 | 1 }], { line number | #program area number }`

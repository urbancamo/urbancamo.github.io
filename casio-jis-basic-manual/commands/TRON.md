...
3. The program stays in the TRON mode until the [TROFF](TROFF.md) statement is executed or
...
P0 represents currently specified program area and 1 the currently executed line number.

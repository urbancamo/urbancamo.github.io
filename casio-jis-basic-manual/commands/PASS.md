...
6. Executing [SAVE](SAVE_SAVE_ALL.md) and [SAVE ALL](SAVE_SAVE_ALL.md) to cassette
...
program to be registered as the computer password. A PR error is generated when the
current password differs from the password of the loaded program.

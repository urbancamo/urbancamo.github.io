...
4. Including a comma between output data causes a zone tab to be inserted between output data and output.
   ...
   following the last carriage return instruction, and zone tabs output spaces from the
...
8. A carriage return is performed when a semicolon or comma is not included at the end of the statement.
...
9. Actual printing begins when a carriage return/line feed code is sent, and carriage return/line feed

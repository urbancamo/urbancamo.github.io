...
| [ACS](commands/ACS)                     | Returns the character code corresponding to the character in the first (leftmost) position of a string                                                                                                                                         |         147 |
...
| [DEG](commands/DEG)                     | Converts a sexagesimal value to a decimal value                                                                                                                                                                                                |         156 |
...
| [HYP ACS](commands/HYP_ASN_ACS_ATN)     | Returns the value of the Inverse Hyperbolic Sine trigonometric function for the argument                                                                                                                                                       |         133 |
...
| [LN](commands/LN)                       | Returns the value of the Natural Logarithm function for the argument                                                                                                                                                                           |         135 |
...
| [LOG](commands/LOG)                     | Returns the value of the Common Logarithm function for the argument                                                                                                                                                                            |         135 |
...
| [PBGET](commands/PBGET)                 | Reads the data file contents under the specified filename and assigns them to $ variable, A() array or A$() array                                                                                                                              |          82 |
| [PBLOAD](commands/PBLOAD)               | Load PB-100 series programs from cassette tape                                                                                                                                                                                                 |          80 |
| [PBLOAD#](commands/PBLOAD)              | Reads data from the specified filename into the DATA BANK                                                                                                                                                                                      |          82 |
| [PBLOAD ALL](commands/PBLOAD)           | Loads all PB-100 series programs from cassette tape                                                                                                                                                                                            |          80 |
...
| [RETURN](commands/RETURN)               | Returns execution from a subroutine to a main program                                                                                                                                                                                          |         100 |
...
| [THEN](commands/IF_THEN)                | Executes the THEN statement or GOTO statement when the specified condition is met. The ELSE statement is executed when the specified condition is not met                                                                                      |         103 |
...
| [VALF](commands/VALF)                   | Performs calculation of numeric expression expressed as string, and returns the result                                                                                                                                                         |         150 |

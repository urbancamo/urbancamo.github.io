...
250 DATAsin𝟷x,xsin𝟷x+√(1-x²)+C,240,260
260 DATAcos𝟷x,xcos𝟷x-√(1-x²)+C,250,270
270 DATAsinhx,coshx+C,260,280
280 DATAcoshx,sinhx+C,270,290
290 DATAtanhx,log(coshx)+C,280,300
300 DATA1/√(a²-x²),sin𝟷(x/a)+C            (➃x➃<a),290,310
310 DATA1/(a²+x²),1/a・tan𝟷(x/a)+C,300,320
320 DATA1/√(x²±a²),log(x+√(x²±a²))+C,310,330
330 DATA√(a²-x²),1/2・(x√(a²-x²)+a²sin𝟷(x/a))+C,320,340

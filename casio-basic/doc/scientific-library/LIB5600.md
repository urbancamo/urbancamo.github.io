...
30 CLS:PRINT"Area (triangle)";TAB(0);"1:ah/2  2:ab・sin𝜃/2  3:f(a,b,c)";:LOCATE0,0:LOCATE0,1
...
130 z=a*h/2:GOTO400
200 CLS:PRINT"ab・sin𝜃/2       a:b:side";
210 s$="a":z=a:GOSUB500:a=z
220 s$="b":z=b:GOSUB500:b=z
230 s$="𝜃":z=d:GOSUB500:d=z:IFSINd<0 THEN230

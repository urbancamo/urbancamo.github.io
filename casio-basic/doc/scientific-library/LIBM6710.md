...
10 MODE8:DIM:GOSUB900:ERASEb$:DIMb$(1):b$(0)="Reject":b$(1)="Accept":t$="Test     H₀:𝜇=𝜇₀  H➀:𝜇"+CHR$(sq)+"𝜇₀":DEFCHR$(254)="A2A49C92A2":c$=CHR$(5):DEFCHR$(252)="123E020000"
...
45 CLS:PRINTt$;
50 z=r:s$="𝜇₀":GOSUB500:r=z
60 z=s:s$="𝜎":GOSUB500:s=z
70 z=t:s$="n":GOSUB500:t=z
80 z=u:s$="➂":GOSUB500:u=z
90 CLS:PRINT"Significance level 𝛼[%]";
95 z=f:s$="𝛼":GOSUB500:f=z:IFf<0 ORf>100 THEN95
97 CLS:PRINTt$;TAB(0);".....";

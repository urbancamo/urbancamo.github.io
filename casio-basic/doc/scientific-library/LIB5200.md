...
50 CLS:PRINT"Romberg's method  ∫f(x)dx [a,b] 1:f(x),[a,b]      2:𝜀,loop";
...
170 m$="Err  ➃An+1-An➃<𝜀  (𝜀>0)":s$="𝜀":z=e:GOSUB800:e=z:IFe<1e-90 THEN170
200 m$="Max loop  2ⁿ     (n>0)":s$="n":z=m:GOSUB800:m=z:IFm=<0ORFRACm<>0THEN200ELSEERASEa:DIMa(m):GOTO50

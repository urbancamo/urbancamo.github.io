...
[Part 11 - Scientific Library](doc/part-11-scientific-library.md) now has a list of all the library routines including links 
...
to process text within a Scala application using Unicode.
